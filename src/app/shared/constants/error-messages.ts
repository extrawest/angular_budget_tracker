...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  [AuthErrorCodes.USER_DELETED]: 'We couldn’t find an account matching the email and password you entered. Please check your email and password and try again.',
